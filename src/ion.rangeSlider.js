...
;(function ($, document, window, navigator, undefined) {
    ...
    var IonRangeSlider = function (input, options, plugin_count) { alert(plugin_count);
        this.VERSION = "2.0.6";
        this.input = input;
...
var container = this.$cache.grid, $text;
...
//Removes small ticks: small_max = 0;
...
container.append('<span class="irs-grid-pol small" style="left: ' + small_w + '%"></span>');
                }

//                html += '<span class="irs-grid-pol" style="left: ' + big_w + '%"></span>';
container.append('<span class="irs-grid-pol" style="left: ' + big_w + '%"></span>');
...
//                html += '<span class="irs-grid-text js-grid-text-' + i + '" style="left: ' + big_w + '%">' + result + '</span>';
								$text = $('<span class="irs-grid-text js-grid-text-' + i + '" style="left: ' + big_w + '%">' + result + '</span>');
								$text.click( function(){ alert('davs'); });
container.append($text);//'<span class="irs-grid-text js-grid-text-' + i + '" style="left: ' + big_w + '%">' + result + '</span>');
            }
